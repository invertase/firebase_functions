...
## Example: Node.js Reference (.gitignore)

Located in `example/nodejs_reference/`, standard Node.js ignores plus:
...
- `example/basic/.dart_tool/firebase/functions.yaml` - Dart manifest
- `example/nodejs_reference/package-lock.json` - For CI caching

These files are **ignored** and regenerated:
- `example/nodejs_reference/nodejs_manifest.json` - Regenerated in CI
...
```bash
git rm -r --cached example/nodejs_reference/node_modules
